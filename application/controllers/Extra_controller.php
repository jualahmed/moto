<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed'); 
	...
	class Extra_controller extends CI_controller{
        ...
        function create_company()
		{
			...
			if($this -> access_control_model -> my_access($data['user_type'], 'Registration', 'company_registration'))
			{
		...
		{
			$data['user_type'] = $this -> tank_auth -> get_usertype();
			if($this -> access_control_model -> my_access($data['user_type'], 'Registration', 'distributor_registration'))
			{
				//* for sale Running Status */
				$data['sale_status'] = '';
				/* end of Sale running Status*/
