		  ...
		  <div class="box">
			...
			<form action ="<?php echo base_url();?>product/search_barcode_barcode" method="post" id="form_22" class="form-horizontal">
				<div class="form-group">
				  ...
				  <div class="col-sm-3">
                    <?php 
						echo form_input('barcode','','class ="form-control one" id="lock" placeholder="Barcode" title="Barcode" autocomplete="off" autofocus="on"');
					?>
                  </div>
				  ...
				  <div class="col-sm-3">
                    <?php
						...
						echo form_dropdown('product_id', $product_info , '' ,'onchange="document.location.href=this.options[this.selectedIndex].value;" class="form-control" style="font-family:Helvetica Neue,Helvetica,Arial,sans-serif;" id="lock5" tabindex="-1" aria-hidden="true"'); 
