                		...
                		<div class="col-md-12">
	                		<form action="<?php echo base_url().'purchase/create' ?>" id="purchase">
		              			<table class="table table-bordered reduce_space" >
									...
									<tr>
					              		<td style="vertical-align: middle;"><b>CHALLAN NO:</b></td>
					              		<td>
					              			<input type="challan_no" name="challan_no" placeholder="CHALLAN NO" class="form-control">
					              		</td>
					              	</tr>

					              	<tr>
					              		<td style="vertical-align: middle;"><b>Distributor:</b></td>
					              		<td>
					              	...
					              	<tr>
					              		<td style="vertical-align: middle;"><b>Purchase Amount:</b></td>
					              		<td>
					              	...
					              	<tr>
					              		...
					              		<td>
					              			<input id="datepickerrr" type="text" name="receipt_date" value="<?php echo date('Y-m-d');?>"  class="form-control datepickerrr"  placeholder="Ex: 12-12-16"/>
					              		</td>
					              	</tr>
						            <tr>
