<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');?>
    ...
    <div class="mid_box_top">
		...
		<?php
			//echo anchor('Report/print_all_company/',img('images/print.png'),'class="mid_box_right_link" target="_blank" title="Print All Company"');
		?>			
	</div>
     ...
     <div class="CSSTableGenerator" style="">
		...
		<?php
		echo form_open('account/expi_dated_selec');
