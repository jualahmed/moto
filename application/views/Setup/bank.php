			...
			<form action="<?php echo base_url();?>bankcard/create_bank" method="post" id="bank" class="form-horizontal">
				<div class="box-body">
					<div class="form-group">
						...
						<div class="col-sm-8">
							<?php 	
								echo form_input('bank_name', '', 'class="form-control" id="bank_name" placeholder="Bank Name" autocomplete="off"');
							?>
						</div>
					</div>
					<br>
					<div class="form-group">
						...
						<div class="col-sm-8">
							<?php 	
								echo form_input('bank_account_no', '', 'class="form-control" id="bank_account_no" placeholder="Bank Account No" autocomplete="off"');
							?>
						</div>
					</div>
					<br>
					<div class="form-group">
						...
						<div class="col-sm-8">
							<?php 	
								echo form_input('bank_account_name', '', 'class="form-control" id="bank_account_name" placeholder="Bank Account Name" autocomplete="off"');
							?>
						</div>
					</div>
					<br>
