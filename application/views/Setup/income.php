					...
					<form action="<?php echo base_url();?>expense/income_create" id="income" method="post" class="form-horizontal">
						<div class="box-body">	
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<?php 	
										echo form_input('income_amount','','class ="form-control"  placeholder="income Amount" id="income_amount" autocomplete="off"');
									?>
								</div>
								<label for="inputEmail3" class="col-sm-2 control-label">Paid Amount</label>
								<div class="col-sm-4">
									<?php 	
										echo form_input('total_paid','','class ="form-control"  placeholder="Paid Amount" id="total_paid" autocomplete="off"');
									?>
								</div>
							</div>
							<br>
							<div class="form-group">
								...
								<div class="col-sm-10">
									<?php 
										 ...
										 echo form_textarea($income_details_full, '', 'class="form-control" rows="4" placeholder="income Details"');
									?> 
								</div>
							</div>
							<br>
	...
	<div class="modal fade" id="show_income_typ_modal">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form id="add_income_form" action="<?php echo base_url(); ?>expense/create_type" method="post" autocomplete="off" enctype="multipart/form-data" role="form">
	...
	<div class="modal fade" id="show_service_provider_modal" >
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form id="add_service_provider_form" action="<?php echo base_url(); ?>Registration/create_service_provider" method="post" autocomplete="off" enctype="multipart/form-data" role="form">
					<div class="modal-body">
						<div class="input-group input-group-sm">
