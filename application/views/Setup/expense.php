					...
					<form action="<?php echo base_url();?>expense/create" id="expense" method="post" class="form-horizontal">
						<div class="box-body">	
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<?php 	
										echo form_input('expense_amount','','class ="form-control"  placeholder="Expense Amount" id="expense_amount" autocomplete="off"');
									?>
								</div>
	...
	<div class="modal fade" id="show_expense_typ_modal">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form id="add_expense_form" action="<?php echo base_url(); ?>expense/create_type" method="post" autocomplete="off" enctype="multipart/form-data" role="form">
