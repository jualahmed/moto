			...
			<div class="col-md-10 col-md-offset-1">
				<div class="box">	 
					<div class="box-body">
						...
						<div class="wrap">
							<div class="box-header with-border" style="background: #0f77ab;"><center><h3 class="box-title" style="color:white;font-family:Helvetica Neue,Helvetica,Arial,sans-serif;">Income</h3></center></div>
							<table class="head">
								<tr>
								  <td style="width:4%;">SL No</td>
								  <td style="width:4%;">Date</td>
							...
							<div class="inner_table">
								<table id="output_income_payment">
								</table>
							</div>
							<table class="head" id="output_income_payment_sum">
							</table>
						</div>
						<div class="wrap">
							<div class="box-header with-border" style="background: #0f77ab;"><center><h3 class="box-title" style="color:white;font-family:Helvetica Neue,Helvetica,Arial,sans-serif;">Income Get</h3></center></div>
							<table class="head">
								<tr>
								  <td style="width:4%;">SL No</td>
								  <td style="width:4%;">Date</td>
							...
							<div class="inner_table">
								<table id="output_income_payment_get">
								</table>
							</div>
							<table class="head" id="output_income_payment_get_sum">
							</table>
						</div>
