$(document).ready(function() {
	$("#form_6").submit(function(event) {
		...
		var output_income_payment = '';
		var output_income_payment_sum = '';
		var output_income_payment_get='';
		var output_income_payment_get_sum = '';
		...
		var total_amount_income_payment = 0.00;
		var total_amount_income_payment_get=0.00;
		var i=0;
		var k= 1;
		var kk= 1;
		var kkk= 1;
		...
		$.ajax({
			...
			{	
				console.log(result.transaction11)
				$(".modal").hide();
				...
				{	
					...
					else if(transaction_purposes=='income')
					{
						
						total_amount_income_payment=0.00;
						for(ii=0; ii<result['transaction10'].length; ii++)
						{	
							
							var amount1=parseFloat(Math.round(result['transaction10'][ii].amount));
							
							total_amount_income_payment+=parseFloat(Math.round(result['transaction10'][ii].amount));
							output_income_payment+='<tr><td style="width: 4%;">'+kkkkkkk+'</td><td style="width: 4%;">'+result['transaction10'][ii].date+'</td><td style="width: 4%;">'+result['transaction10'][ii].type_type+'</td><td style="width: 4%;">'+result['transaction10'][ii].income_details+'</td><td style="width: 4%;">'+result['transaction10'][ii].remarks+'</td><td style="overflow: hidden;text-overflow: ellipsis; white-space: nowrap;width: 4%;text-align:right;">'+amount1.toFixed(2)+'</td></tr>';
							kkkkkkk++;
						}
					}
					else if(transaction_purposes=='income_get')
					{
						
						total_amount_income_payment_get=0.00;
						for(ii=0; ii<result['transaction11'].length; ii++)
						{	
							
							var amount1=parseFloat(Math.round(result['transaction11'][ii].amount));
							
							total_amount_income_payment_get+=parseFloat(Math.round(result['transaction11'][ii].amount));
							output_income_payment_get+='<tr><td style="width: 4%;">'+kkkkkkk+'</td><td style="width: 4%;">'+result['transaction11'][ii].date+'</td><td style="width: 4%;">'+result['transaction11'][ii].type_type+'</td><td style="width: 4%;">'+result['transaction11'][ii].income_details+'</td><td style="width: 4%;">'+result['transaction11'][ii].remarks+'</td><td style="overflow: hidden;text-overflow: ellipsis; white-space: nowrap;width: 4%;text-align:right;">'+amount1.toFixed(2)+'</td></tr>';
							kkkkkkk++;
						}
					}
				}
				...
				output_income_payment_sum+='<tr><td style="width:4%;"></td><td style="width:4%;"></td><td style="width:4%;"></td><td style="width:4%;"></td><td style="width:4%;">Total</td><td style="width: 4%;text-align:right;">'+total_amount_income_payment.toFixed(2)+'</td></tr>';
				output_income_payment_get_sum+='<tr><td style="width:4%;"></td><td style="width:4%;"></td><td style="width:4%;"></td><td style="width:4%;"></td><td style="width:4%;">Total</td><td style="width: 4%;text-align:right;">'+total_amount_income_payment_get.toFixed(2)+'</td></tr>';
				...
				if(output_income_payment != '')
				{
					$('#output_income_payment').html(output_income_payment);
					$('#output_income_payment_sum').html(output_income_payment_sum);
					$('#infomsg').show();
					$('#down').show();
				}
				else
				{
					$('#output_income_payment').html("No Data Available");
					$('#infomsg').show();
					$('#down').show();
				}
				if(output_income_payment_get != '')
				{
					$('#output_income_payment_get').html(output_income_payment_get);
					$('#output_income_payment_get_sum').html(output_income_payment_get_sum);
					$('#infomsg').show();
					$('#down').show();
				}
				else
				{
					$('#output_income_payment_get').html("No Data Available");
					$('#infomsg').show();
					$('#down').show();
				}
